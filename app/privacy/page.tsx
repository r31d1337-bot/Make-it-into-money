    ...
    <main className="relative mx-auto max-w-3xl px-4 py-6 sm:px-6 sm:py-10">
      ...
      <article className="markdown">
        ...
        <ul>
          ...
          <li>
            <strong>Device-local data.</strong> Your history sidebar and
            checklist state are stored in your browser&apos;s localStorage.
        ...
        <p>
          Email <a href="mailto:team@adroitventures.io">team@adroitventures.io</a> to make
